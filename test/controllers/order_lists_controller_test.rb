...
class OrderListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_list" do
    assert_difference('OrderList.count') do
      post order_lists_url, params: { order_list: { category_id: @order_list.category_id, order_id: @order_list.order_id, specialist_id: @order_list.specialist_id } }
    end
  ...
  test "should update order_list" do
    patch order_list_url(@order_list), params: { order_list: { category_id: @order_list.category_id, order_id: @order_list.order_id, specialist_id: @order_list.specialist_id } }
